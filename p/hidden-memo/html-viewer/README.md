...
파일이 크거나 URL 열기가 실패한다면 Base64 대신 클립보드로 전달합니다. Safari 보안 정책상 자동으로 클립보드를 읽을 수 없어 Viewer에서 **단축어 HTML 열기**를 한 번 눌러야 하지만, HTML 본문을 URL에 넣지 않아 더 안정적입니다.
...
5. **URL 열기**로 Viewer를 연 뒤 **단축어 HTML 열기**를 누릅니다. 클립보드 접근 안내가 나오면 허용합니다.
