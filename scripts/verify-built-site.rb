...
fail_with("home should darken the mobile safe area") unless home_html.include?("viewport-fit=cover") && home_html.include?("#070a10")
...
fail_with("home cursor trail should suppress slow-move flashing") unless home_html.include?("visibleMotion") && home_html.include?("pointerType !== 'mouse'")
